...
abstract class Palette {
  /// Chromatic color (유채색)
  static Color red = const Color(0xFFFF334B);
  static Color orange = const Color(0xFFFF6F36);
  static Color yellow = const Color(0xFFFFC53D);
  static Color green = const Color(0xFF06C755);
  static Color blue = const Color(0xFF4270ED);
  static Color navy = const Color(0xFF5F5FED);
  static Color purple = const Color(0xFFC355D9);
